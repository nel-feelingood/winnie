...
Личный проект: собирается из исходников, в App Store и в виде готовой сборки не распространяется.
...
Исходный код — © Sergey Donskov, все права сохранены; лицензия на использование не выдаётся.
Винни-Пух — персонаж фильмов Фёдора Хитрука («Союзмультфильм»); спрайты нарисованы для личного
использования и не предназначены для распространения.
