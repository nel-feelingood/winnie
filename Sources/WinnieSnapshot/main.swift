...
let wantsEvents = arguments.count > 2 && arguments[2] == "events"
...
MainActor.assumeIsolated {
    ...
    store.append(ChatMessage(role: .user, text: "Привет, как слышно?"), to: session.id)
    store.append(ChatMessage(role: .assistant, text: "Слышно хорошо, Серёжа. Сижу тут в опилках, **урчу** потихоньку.\n\n- мёд\n- ещё мёд",
