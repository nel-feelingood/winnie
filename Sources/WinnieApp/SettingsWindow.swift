...
struct SettingsView: View {
    ...
    @ViewBuilder private var winniePane: some View {
        ...
        Section {
            ...
            Footnote("16:20 — каждый день в это время Винни устраивает перекур; по просьбе в чате («16:20», «перекур») анимация играет в любое время, даже если тумблер выключен. Сны — пока Винни спит, над ним раз в 10 секунд всплывает случайный эмодзи из всего набора.")
        }
        Section {
