    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Характер Винни и то, как он отвечает. Написан по-английски ради экономии токенов; править и дописывать можно на любом языке. Применяется со следующего сообщения.")
            }
            Section {
