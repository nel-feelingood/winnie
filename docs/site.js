...
if (list) {
  const cases = [
    { c: '--violet', icon: '🎙️', title: 'Слушать по шорткату', note: 'Диктовка из любого приложения. Распознавание на устройстве, ответ можно получить вслух.',
      keys: ['⇧', '⌘', 'E'], pose: 'listening', ask: 'сколько граммов в стакане муки?', text: 'Около 130 граммов.' },
    { c: '--acc', icon: '⏰', title: 'Напомнить', note: 'Время берётся из фразы. Уведомление приходит, даже когда медведь спрятан.',
      ask: 'напомни через 40 минут достать пирог', card: ['Достать пирог', 'сегодня, 14:40'] },
    { c: '--blue', icon: '⚡', title: 'Быстрая команда', note: 'Кнопка в пустом чате. Подпись короткая, инструкция под ней любая.',
    ...
    { c: '--yellow', icon: '📝', title: 'Записать', note: 'Заметки – Markdown-файлы на диске. Медведь создаёт и дополняет их сам.',
      ask: 'запиши в Идеи: прогулка по экрану', text: 'Добавил в заметку «Идеи».' },
    { c: '--blue', icon: '🌍', title: 'Перевести', note: 'Текст в ответе можно выделить, рядом появляется кнопка Copy.',
      ask: 'переведи вежливо: давайте перенесём созвон на четверг', text: 'Could we please move the call to Thursday?' },
    { c: '--blue', icon: '🔎', title: 'Найти', note: 'Ищет в вебе, под ответом ссылки на источники.',
